...
},{"Prelude":15}],2:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Prelude = require("Prelude");
...
},{"Control.Alt":1,"Control.Lazy":5,"Prelude":15}],3:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Prelude = require("Prelude");
...
},{"Prelude":15}],4:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Prelude = require("Prelude");
...
},{"Control.Plus":8,"Prelude":15}],8:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Prelude = require("Prelude");
...
},{"Control.Alt":1,"Control.Alternative":2,"Control.MonadPlus":7,"Control.Plus":8,"Data.Maybe":10,"Prelude":15,"Prelude.Unsafe":14}],10:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Prelude = require("Prelude");
...
},{"Control.Alt":1,"Control.Alternative":2,"Control.Extend":4,"Control.MonadPlus":7,"Control.Plus":8,"Prelude":15}],11:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Prelude = require("Prelude");
...
},{"Data.Array":9,"Data.Maybe":10,"Prelude":15}],12:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Prelude = require("Prelude");
...
},{"Control.Comonad":3,"Control.Extend":4,"Control.Lazy":5,"Data.Array":9,"Data.Monoid":11,"Prelude":15}],13:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Prelude = require("Prelude");
...
var setCompleted = function (_3) {
    return function (_4) {
        return new Item(_4.value0, _3);
    };
};
            ...
            return function (_11) {
                if (_10 instanceof NewItem) {
                    return _11(new State((function () {
                        var _44 = {};
                        for (var _45 in _8.value0) {
                            if (_8.value0.hasOwnProperty(_45)) {
                                _44[_45] = _8.value0[_45];
                            };
                        };
                        _44.items = Prelude["++"](Data_Array.semigroupArray)(_8.value0.items)([ new Item(_10.value0, false) ]);
                        _44.editText = "";
                        return _44;
                    })()));
                };
                if (_10 instanceof RemoveItem) {
                    return _11(new State((function () {
                        var _48 = {};
                        for (var _49 in _8.value0) {
                            if (_8.value0.hasOwnProperty(_49)) {
                                _48[_49] = _8.value0[_49];
                            };
                        };
                        _48.items = Data_Array.deleteAt(_10.value0)(1)(_8.value0.items);
                        return _48;
                    })()));
                };
                if (_10 instanceof SetEditText) {
                    return _11(new State((function () {
                        var _52 = {};
                        for (var _53 in _8.value0) {
                            if (_8.value0.hasOwnProperty(_53)) {
                                _52[_53] = _8.value0[_53];
                            };
                        };
                        _52.editText = _10.value0;
                        return _52;
                    })()));
                };
                if (_10 instanceof SetCompleted) {
                    return _11(new State((function () {
                        var _56 = {};
                        for (var _57 in _8.value0) {
                            if (_8.value0.hasOwnProperty(_57)) {
                                _56[_57] = _8.value0[_57];
                            };
                        };
                        _56.items = Data_Array.updateAt(_10.value0)(setCompleted(_10.value1)(_8.value0.items[_10.value0]))(_8.value0.items);
                        return _56;
                    })()));
                };
                if (_10 instanceof SetFilter) {
                    return _11(new State((function () {
                        var _61 = {};
                        for (var _62 in _8.value0) {
                            if (_8.value0.hasOwnProperty(_62)) {
                                _61[_62] = _8.value0[_62];
                            };
                        };
                        _61.filter = _10.value0;
                        return _61;
                    })()));
                };
...
var applyFilter = function (_1) {
    return function (_2) {
        if (_1 instanceof All) {
            return true;
        };
        if (_1 instanceof Active) {
            return !_2.value1;
        };
        if (_1 instanceof Completed) {
            return _2.value1;
        };
        throw new Error("Failed pattern match");
    };
...
var render = function (_5) {
    return function (_6) {
        return function (_7) {
            ...
            var newItem = Thermite_Html_Elements.li([ Thermite_Html_Attributes.className("newItem") ])([ Thermite_Html_Elements.input([ Thermite_Html_Attributes.placeholder("Create a new task"), Thermite_Html_Attributes.value(_6.value0.editText), Thermite_Events.onKeyUp(_5)(handleKeyPress), Thermite_Events.onChange(_5)(handleChangeEvent) ])([  ]) ]);
            var item = function (_14) {
                return Thermite_Html_Elements["li'"]([ Thermite_Html_Elements.input([ Thermite_Html_Attributes._type("checkbox"), Thermite_Html_Attributes.className("completed"), Thermite_Html_Attributes.checked((function () {
                    ...
                    throw new Error("Failed pattern match");
                })()), Thermite_Html_Attributes.title("Mark as completed"), Thermite_Events.onChange(_5)(handleCheckEvent(_14.value1)) ])([  ]), Thermite_Html_Elements.span([ Thermite_Html_Attributes.className("description") ])([ Thermite_Html.text(_14.value0.value0) ]), Thermite_Html_Elements.button([ Thermite_Html_Attributes.className("complete"), Thermite_Html_Attributes.title("Remove item"), Thermite_Events.onClick(_5)(function (_) {
                    return new RemoveItem(_14.value1);
                }) ])([ Thermite_Html.text("\u2716") ]) ]);
            };
            var items = Thermite_Html_Elements.ul([ Thermite_Html_Attributes.className("items") ])(Prelude[":"](newItem)(Prelude["<<<"](Prelude.semigroupoidArr)(Data_Array.map(item))(Data_Array.filter(Prelude["<<<"](Prelude.semigroupoidArr)(applyFilter(_6.value0.filter))(Data_Tuple.fst)))(Data_Tuple.zip(_6.value0.items)(Data_Array[".."](0)(Data_Array.length(_6.value0.items))))));
            var filter_ = function (f) {
                return Thermite_Html_Elements.li([  ])([ Thermite_Html_Elements.a([ Thermite_Html_Attributes.href("#"), Thermite_Html_Attributes.className((function () {
                    var _83 = Prelude["=="](eqFilter)(f)(_6.value0.filter);
                    if (_83) {
                        return "selected";
                    };
                    if (!_83) {
            ...
            return Thermite_Html_Elements.div([ Thermite_Html_Attributes.className("body") ])([ title, items, filters ]);
        };
    };
};
var spec = {
...
},{"Control.Monad.Eff":6,"Data.Array":9,"Data.Tuple":12,"Prelude":15,"Prelude.Unsafe":14,"Thermite":20,"Thermite.Events":16,"Thermite.Html":19,"Thermite.Html.Attributes":17,"Thermite.Html.Elements":18}],14:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Prelude = require("Prelude");
...
},{"Prelude":15}],15:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Unit = {
...
},{"Prelude":15}],17:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Prelude = require("Prelude");
...
},{"Prelude":15}],18:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Thermite_Html = require("Thermite.Html");
var Prelude = require("Prelude");
...
},{"Prelude":15,"Thermite.Html":19}],19:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Prelude = require("Prelude");
...
},{"Prelude":15}],20:[function(require,module,exports){
// Generated by psc-make version 0.6.2
"use strict";
var Prelude = require("Prelude");
var Spec = {
...
},{"Prelude":15}],21:[function(require,module,exports){
require('Main').main();
